...
Software Engineer graduated from the **University of Brasília (UnB)**. I have a proven track record of delivering high-impact solutions, such as refactoring front-end architectures to significantly reduce **AWS operational costs** while improving code maintainability.
